...
export const rainbow7: Animal = {
  ...
  steps: [
    ...
    { hint: "Finish the arcs with violet! 🟣", color: "#9b5de5", strokes: ["M 88,160 A 12,12 0 0,1 112,160"] },
    {
      ...
      color: "#9aa5b1",
      strokes: [
        "M 22,164 Q 12,164 14,153 Q 11,144 25,146 Q 30,136 43,144 Q 52,142 50,156 Q 56,164 43,164 Z",
      ],
    },
    {
      ...
      color: "#9aa5b1",
      strokes: [
        "M 178,164 Q 188,164 186,153 Q 189,144 175,146 Q 170,136 157,144 Q 148,142 150,156 Q 144,164 157,164 Z",
      ],
    },
    {
