...
// A very detailed long-necked dinosaur with plates, arms and a scene (10-year-old level).
export const dinosaur10: Animal = {
  ...
  viewBox: "0 0 200 200",
  steps: [
    { hint: "Draw a big round body 🦕", strokes: ["M 60,128 a 46,28 0 1,0 92,0 a 46,28 0 1,0 -92,0"] },
    {
    ...
    { hint: "Add a long swishy tail", strokes: ["M 148,132 Q 182,126 186,152"] },
    {
      hint: "Give it four chunky legs",
      strokes: ["M 78,150 L 78,168 M 100,154 L 100,170 M 122,154 L 122,170 M 142,150 L 142,166"],
    },
    {
      hint: "Add little arms",
      strokes: ["M 80,118 Q 70,124 70,132"],
    },
    {
