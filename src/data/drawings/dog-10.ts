...
// An even more detailed sitting dog with a collar and a little scene (10-year-old level).
export const dog10: Animal = {
  ...
  viewBox: "0 0 200 200",
  steps: [
    { hint: "Start with the round head", strokes: ["M 70,52 a 30,30 0 1,0 60,0 a 30,30 0 1,0 -60,0"] },
    {
    ...
    { hint: "Add a wagging tail!", strokes: ["M 124,138 Q 150,132 146,108"] },
    {
